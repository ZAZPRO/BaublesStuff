/*
 * This class (BlockExpGenerator.java) was created by <zazpro>. It's distributed as
...
public class BlockExpGenerator extends BlockContainer {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        if (stack.hasDisplayName()) {
            ((TEExpGenerator) worldIn.getTileEntity(pos)).setCustomName(stack.getDisplayName());
        }
    }
