/*
 * This class (TEBookGenerator.java) was created by <zazpro>. It's distributed as
...
public class TEBookGenerator extends TileEntity implements IInventory {
    private ItemStack[] inventory;
    private String customName;

    public TEBookGenerator() {
