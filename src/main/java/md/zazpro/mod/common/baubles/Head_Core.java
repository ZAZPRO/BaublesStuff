/*
 * This class (Head_Core.java) was created by <zazpro>. It's distributed as
...
public class Head_Core extends BaubleBase {
    ...
    public void getSubItems(Item item, CreativeTabs tab, List itemList) {
        for (int i = 0; i < Head_CoreVariants.length; i++) {
            ...
            itemStack.getTagCompound().setString("ItemModel", Head_CoreVariants[i]);
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        if (!stack.hasTagCompound()) {
            ...
            stack.getTagCompound().setString("ItemModel", Head_CoreVariants[0]);
        }
    }
}
